 ...
 * The Ends will have to be deactivated for the frog to be able to enter.
 * The activation of each hole is set to false at the start.
 */
public class End extends Actor {

	/**
	 * Activation status of the frog hole.
	 */
	boolean activated = false;

	/**
	 * This method will define how the End (frog hole) is supposed to act in each frame.
	...
	/**
	 * This method will toggle a change in the activation status of the frog hole.
