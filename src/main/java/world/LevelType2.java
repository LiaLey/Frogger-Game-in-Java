...
public class LevelType2 extends MyLevel {
    ...
    public LevelType2(){
        ...
        this.add(new Log("file:src/main/resources/images/logs.png", 300, 0, 276, -0.75));
        this.add(new Log("file:src/main/resources/images/logs.png", 300, 400, 276, -0.75));
        ...
        this.add(new Truck("file:src/main/resources/images/truck1"+"Right.png", 0, 649, 1, 120, 120));
